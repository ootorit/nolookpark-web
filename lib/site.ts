...
export const EVENT = {
  ...
  price: [
    ...
    "こども: ¥500",
    "ファミリー: ¥2,000",
    "※ ファミリーチケットは同一世帯の方は一律¥2,000で参加いただけます。",
  ],
} as const;
...
export const CONTENTS: {
...
}[] = [
  {
    ...
    desc: "手探りでお菓子を楽しむ、触覚駄菓子屋さん。君はおつかいでこの店を訪れるが、ルールは一つ「ノールックで商品を選ぶこと」。目を使わずに味を当てたり、銘柄を選んだり…。今までと違うお菓子体験ができます。",
  },
  {
    num: "02",
    title: "たっちまっち",
  ...
  },
  {
    ...
    desc: "視覚に頼らず、身体感覚と内なる感覚を頼りに書いていく新しいジャンルの書道。思い切って、自由に、あなたらしく！快感！",
  },
  {
    num: "07",
    title: "TOUCH PARK",
...
export const ORGANIZERS = [
  {
    ...
    desc: "コピーライター／世界ゆるスポーツ協会 代表理事。だれもが楽しめる新しいスポーツを120以上開発し30万人以上が体験。福祉領域の事業も多数手がける。著書に『マイノリティデザイン』など。",
  },
  {
    num: "02",
    name: "石井健介",
