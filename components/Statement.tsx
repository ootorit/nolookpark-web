      ...
      <div className="flex flex-col gap-6 rounded-2xl bg-ink-soft p-6 ring-1 ring-inset ring-line-dark sm:flex-row sm:items-center">
        ...
        <div className="flex flex-1 flex-col gap-2.5">
          <div className="flex items-center gap-2.5">
            <span className="font-en rounded bg-brand px-2 py-1 text-[10px] tracking-[2px] text-ink">
              PODCAST
            </span>
            <span className="font-en text-[11px] tracking-[2px] text-white">
              EP.01
            </span>
          </div>
          <h3 className="text-xl tracking-[1px] text-white">
            「見ない」からはじまる話
          </h3>
          <p className="text-xs text-white">NO LOOK BROTHERS ／ 24分18秒</p>
          ...
          <div className="flex items-center justify-between">
            <span className="font-en text-[11px] text-white">07:42</span>
            <span className="font-en text-[11px] text-white">24:18</span>
          </div>
        </div>

        <div className="flex items-center justify-center gap-4">
          <button aria-label="15秒戻る" className="text-white transition-colors hover:text-white">
            <RotateCcw size={20} />
          </button>
          <button
            aria-label="再生"
          ...
          <button aria-label="15秒進む" className="text-white transition-colors hover:text-white">
            <RotateCw size={20} />
          </button>
        </div>
      </div>
