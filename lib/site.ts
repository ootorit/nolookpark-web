...
export const STATEMENT_BODY = [
  "NO LOOK PARKへようこそ！ ここは、みえない状態で（アイマスクを配ります）、ゲームをしたり、駄菓子を買ったり、お茶をブレンドしたりする場所。",
  "みえないからこそドキドキしたり、ニヤッとしたり、ホッとしたり、新感覚を味わえます。",
  "ショート動画、Instagram、デジタルアート。「みる」ことに大忙しの時代です。だからこそ、残りの四つの感覚を、思いきり喜ばせたい。そんな想いで、見えない人と見える人がアイデアを持ち寄って、この場所をつくりあげました。",
  "「みえないって、こんなに面白いのか！」そう思ってもらえたら──。",
] as const;
